    ...
    <table cellpadding="0" cellspacing="0" border="0" width="90%">
      <thead>
        <tr>
             <th>name</th>
             <th>roll number</th>
             <th>clearence by assistant registrar</th>
             <th>new status</th>
             <th>update status </th>
	     <th></th>
...
mysql_select_db("stud",$con);
 ...
 if(isset($_POST['a'])){
	...
	$updatec = "UPDATE chukya SET assregistrar='$_POST[a]'  WHERE  rollno='$b' " ;
...
if($rec['warden']=='paid' && $rec['library']=='paid' && $rec['finance']=='paid')
{
echo "<form action = assregistrar.php  method =POST>";
echo "<tr>";
echo "<td>" . $rec['name'] . " </td>";
echo "<td>" . $rec['rollno'] . " </td>";
echo "<td>" . $rec['assregistrar'] . "</td>";
